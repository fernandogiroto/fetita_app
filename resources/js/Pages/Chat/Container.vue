...
<template>
    ...
    <AppLayout>
        ...
        <div class="page-header overlay-dark d-print-none">
          ...
          <div class="page-body">
            <div class="container-xl">
                <ChatRoomSelecion v-if="currentRoom.id" 
                :rooms="chatRooms" :currentRoom="currentRoom" v-on:roomchanged="setRooms($event)"></ChatRoomSelecion>
                <MessageCotainer :messages="messages"></MessageCotainer>
  ...
  <script setup type="module">
    ...
    import MessageCotainer from './MessageContainer.vue';
    import InputMessage from './InputMessage.vue';
    import ChatRoomSelecion from './ChatRoomSelecion.vue';
    ...
    watch(currentRoom, (newCurrentRoom, currentRoom) => {
        console.log(currentRoom)
        if(currentRoom.id) {
            disconect(currentRoom);   
        }
        connect();
    });
